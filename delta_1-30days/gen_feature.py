...
if feature_engineer:
    ...
    # 增加uid_D3特征(替换为shift)
    uid_D3_train = pd.read_csv("../features/train_target_encoding_D3_shift.csv")
    ...
    # 增加uid_D5特征
    # uid_D5_train = pd.read_csv("../features/train_target_encoding_D5.csv")
    # X = X.merge(uid_D5_train, on="TransactionID", how="left")
    # test_X = test_X.merge(uid_D5_train, on="TransactionID", how="left")
    #
    # # 增加uid_D6特征
    # uid_D6_train = pd.read_csv("../features/train_target_encoding_D6.csv")
    # X = X.merge(uid_D6_train, on="TransactionID", how="left")
    # test_X = test_X.merge(uid_D6_train, on="TransactionID", how="left")

    # 增加uid_D10_TransactionAmt特征
    # uid_D10_TransactionAmt_train = pd.read_csv("../features/uid_D10_TransactionAmt_train.csv")
    ...
    uid_D15_new_train = pd.read_csv("../features/train_target_encoding_D15_pEmail.csv")
