...
uid_D3_test = pd.read_csv("../features/test_target_encoding_D3_shift.csv")
...
# 增加uid_target特征
train_uid_target = pd.read_csv("../features/train_uid_target.csv")
test_uid_target = pd.read_csv("../features/test_uid_target.csv")
train = train.merge(train_uid_target, on="TransactionID", how="left")
test = test.merge(test_uid_target, on="TransactionID", how="left")
